...
grant select, insert, update on ofd_supplier to ofd_supplier_01; 
grant select on ofd_products to ofd_supplier_01; 
grant select on ofd_category to ofd_supplier_01; 

grant select, insert, update on ofd_supplier to ofd_supplier_02; 
grant select on ofd_products to ofd_supplier_02; 
grant select on ofd_category to ofd_supplier_02; 

---Customer User Permission 

grant select, insert, update on ofd_customer to ofd_customer_01; 
grant select on ofd_orders to ofd_customer_01; 
grant select on ofd_order_details to ofd_customer_01; 

grant select, insert, update on ofd_customer to ofd_customer_02; 
grant select on ofd_orders to ofd_customer_02; 
grant select on ofd_order_details to ofd_customer_02; 

grant select, insert, update on ofd_customer to ofd_customer_03; 
grant select on ofd_orders to ofd_customer_03; 
grant select on ofd_order_details to ofd_customer_03; 
